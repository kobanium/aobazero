...
#define UINT64_MAX (0xffffffffffffffffui64)		// gccでは定義済み
#else
#include <stdint.h>
#include <sys/time.h>
#include <unistd.h>
//#include <inttypes.h>		// PRIx64 , "llx" よりは PRIx64 を使うべき、だがcppだと未定義？
#ifndef UINT64_MAX
  #define UINT64_MAX (18446744073709551615ULL)	// gccでは拡張子が c だと定義で cpp だと未定義
#endif
#ifndef PRIx64
  #define PRIx64	"llx"
  #define PRIu64	"llu"
