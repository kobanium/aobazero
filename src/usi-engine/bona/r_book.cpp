...
//	FILE *fp = fopen("/home/yss/prg/dlshogi_book/20240427_215134_20240429_095732.log","r");	// 1手2500000局面で
	FILE *fp = fopen("/home/yss/prg/dlshogi_book/20250423_225032.log","r");	// 1手5000000局面で
...
#if 0	// dlshogiではsfenとbestmoveのtxtを読むだけに。盤面作るの面倒だから
	FILE *fp2 = fopen("aobasfenbest.txt","w");
	if ( !fp2 ) DEBUG_PRT("");
	for (int i=0; i<sfen_book_num; i++) {
		fprintf(fp2,"%s\n",sfen_book[i].c_str());
		fprintf(fp2,"%s\n",sfen_book_best[i].c_str());
	}
#endif
...
void read_sfen_best() {
//	FILE *fp = fopen("20240417_232213aobasfenbest.txt","r");
	FILE *fp = fopen("20240427_215134_20240429_095732aobasfenbest.txt","r");
	if ( !fp ) DEBUG_PRT("");
	int n = 0;
	for (;;) {
		const int T_LEN = 10000;
...
//		{ 0, "position startpos moves 2g2f 8c8d 2f2e 8d8e 6i7h 4a3b 3i3h 9c9d 9g9f 7a7b 3g3f 8e8f 8g8f 8b8f 5i6h 1c1d 2i3g 7c7d 2e2d 2c2d 2h2d P*2c 2d7d 7b7c P*8g 8f8b 7d7e 7c6d 7e2e 3c3d 7g7f 4c4d 4g4f 3a4b 4i4h 4b4c 3h4g 6a5b 6h5h 2a3c 2e2i 8b7b 7h7g 5c5d 5h6h 2b3a 7i7h 7b8b 1g1f 5a4a 6g6f 8a7c 8g8f 8b8d 7g8g P*7e 6f6e 6d6e 4f4e 5d5e 8h5e 8d7d 7f7e 3a7e P*7f 7e5c 7h6g P*8e P*6d 6e5d 7f7e 7d8d 8f8e 8d8e P*8f 8e8d 5e8h 4d4e 4g5f P*5e 5f5e 5d5e 8h5e 5c6d 5e6d 8d6d S*7d P*7b 7d7c 7b7c N*5f 6d8d P*4d 4c5d B*7f S*6e 7f6e 5d6e S*4c S*4b 8i7g 6e5f 4c3b 4a3b 6g5f P*5h S*2a 3b4a 2i2c+ B*5d 5f6e B*5i 6h5h 5i4h+ 5h4h N*5e B*2i S*4g 2i4g 5e4g+ 4h4g B*6i 4g3h 4a5a P*6b G*4g 3h2i 5a6b N*7d 7c7d 6e5d 4g3g 7g6e 6i4g+ 2i1h N*6a B*4a P*5a P*6d N*7a 6d6c+ 5b6c 2c3b 4g3f 1h2i 3f4g 2i1h 3g2h 1h2h P*2g 2h3i 4g5g G*4h 5g7e 3b4b 7e4b 5d6c 7a6c S*7c 6a7c G*5c 4b5c 6e5c+ 6b5c 4d4c+" },
		// N+koron, N-dlshogi
//{ 0,"position startpos moves 2g2f 8c8d 7g7f 4a3b 2f2e 8d8e 8h7g 3c3d 7i8h 2b7g+ 8h7g 3a2b 6i7h 2b3c 1g1f 1c1d 3i3h 7a6b 3g3f 6c6d 5i6h 6b6c 4g4f 5a4b 2i3g 7c7d 9g9f 8a7c 3f3e 6a6b 3e3d 3c3d 2e2d 2c2d 2h2d 3d2c 2d2i P*2d 3h4g 7d7e 4i4h 7e7f 7g7f 8b8a B*5f P*7d P*7e 7d7e 7f7e P*7d 7e7d 6c7d 5f7d 7c6e P*2e 2d2e P*3c 2a3c P*2d 2c3d S*6c 6b6a P*3e 3d3e 8i7g 8e8f 8g8f 8a8f 7g6e 6d6e P*3d N*7f 6h5h S*2h 2i2h 8f8i+ S*6i P*7g 3d3c+ 3b3c 3g2e 3c2d 6c5b+ 6a5b 2e3c+ 4b3c 7d5b+ P*2g N*4e 3c2c 5b4c P*3b P*2e 2d3d 2h2g P*2f G*2d 3d2d 2e2d 2c2d" },
	...
	for (int loop = 0; ;loop++) {
		...
		int count = 0;
		char ch = ' ';
		for (std::string::size_type i = 0; (i = s.find(ch, i)) != std::string::npos; i++) {
			count++;
		}
...
//	if ( strstr(sfen.c_str(),"position sfen lnsgkgsnl/1r5b1/ppppppppp/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL b -" ) ) return "7g7f";
	...
	// 2手目32金の変化で8手目に自分から角交換しないように。2300万局面での最善手
	if ( strstr(sfen.c_str(),"position sfen lnsgk1snl/1r4gb1/p1pppp1pp/1p4p2/7P1/2P6/PP1PPPP1P/1BG4R1/LNS1KGSNL w -" ) ) return "8d8e";
	if ( strstr(sfen.c_str(),"position sfen ln1gk2nl/2s3gs1/p1p1ppbp1/3p2p1p/7P1/1rP2PP2/P2PP1N1P/1BG1KGS2/LNS4RL w Pp" ) ) return "8f8b";
